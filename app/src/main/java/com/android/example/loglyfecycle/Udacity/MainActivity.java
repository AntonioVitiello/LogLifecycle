package com.android.example.loglyfecycle.Udacity;
...
/**
 * Created by antlap on 06/12/2017.
 */
...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPLETED: 06/12/2017 12:34 was TODO (1) Declare and instantiate a static ArrayList of Strings called mLifecycleCallbacks
    public static final List<String> mLifecycleCallbacks = new ArrayList();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.udacity_activity_main);
        ...
        // COMPLETED: 06/12/2017 12:41 was TODO (4) Iterate backwards through mLifecycleCallbacks, appending each String and a newline to mLifecycleDisplay
        // COMPLETED: 06/12/2017 12:41 was TODO (5) Clear mLifecycleCallbacks after iterating through it
        for (int i = mLifecycleCallbacks.size() - 1; i >= 0; i--) {
            mLifecycleDisplay.append(mLifecycleCallbacks.remove(i)+ "\n");
        }
    ...
    protected void onStop() {
        ...
        // COMPLETED: 06/12/2017 12:34 was TODO (2) Add the ON_STOP String to the front of mLifecycleCallbacks
    ...
    protected void onDestroy() {
        ...
        // COMPLETED: 06/12/2017 12:35 was TODO (3) Add the ON_DESTROY String to the front of mLifecycleCallbacks
